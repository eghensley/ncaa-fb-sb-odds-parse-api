...
public class BoxScorePojo {
    ...
    private ArrayList<BoxScoreTablePojo> tables;
	...
	public BoxScorePojo(String inputMD5Sum, String updatedTimestamp, BoxScoreMetaPojo meta,
			ArrayList<BoxScoreTablePojo> tables) {
		super();
	 ...
	 * @return the tables
	 */
	public ArrayList<BoxScoreTablePojo> getTables() {
		return tables;
	}
	 ...
	 */
	public void setTables(ArrayList<BoxScoreTablePojo> tables) {
		this.tables = tables;
	}
