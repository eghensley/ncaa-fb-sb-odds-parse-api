...
//    private ArrayList<BoxScoreHeaderPojo> header;
    private ArrayList<BoxScoreDataPojo> data;
    
    public BoxScoreTablePojo() {
    	
    }

	public BoxScoreTablePojo(String id, String headerColor, String headerClass, ArrayList<BoxScoreDataPojo> data) {
		super();
		this.id = id;
	 ...
	 * @return the data
	 */
	public ArrayList<BoxScoreDataPojo> getData() {
		return data;
	}
	 ...
	 */
	public void setData(ArrayList<BoxScoreDataPojo> data) {
		this.data = data;
	}
