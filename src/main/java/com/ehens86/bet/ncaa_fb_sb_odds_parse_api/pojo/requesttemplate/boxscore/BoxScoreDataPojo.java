...
public class BoxScoreDataPojo {
    private List<BoxScoreRowPojo> row;
    @JsonProperty("class") 
	...
	public BoxScoreDataPojo(List<BoxScoreRowPojo> row, String rowClass) {
		super();
		this.row = row;
	 ...
	 * @return the row
	 */
	public List<BoxScoreRowPojo> getRow() {
		return row;
	}
	 ...
	 */
	public void setRow(List<BoxScoreRowPojo> row) {
		this.row = row;
	}
