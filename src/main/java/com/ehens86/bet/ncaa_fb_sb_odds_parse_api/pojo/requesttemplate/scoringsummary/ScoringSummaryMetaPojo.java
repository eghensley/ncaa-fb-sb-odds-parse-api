...
public class ScoringSummaryMetaPojo {
    ...
    private List<ScoringSummaryTeamPojo> teams;
    
    public ScoringSummaryMetaPojo() {
    	
    }

	public ScoringSummaryMetaPojo(String title, List<ScoringSummaryTeamPojo> teams) {
		super();
		this.title = title;
		this.teams = teams;
	}
	 ...
	 * @return the teams
	 */
	public List<ScoringSummaryTeamPojo> getTeams() {
		return teams;
	}
	 ...
	 */
	public void setTeams(List<ScoringSummaryTeamPojo> teams) {
		this.teams = teams;
	}
